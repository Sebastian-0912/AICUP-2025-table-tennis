...
def feature(input_data, swinging_now, swinging_times, n_fft, a_fft, g_fft, a_fft_imag, g_fft_imag, writer):
    ...
    # Entropy (add epsilon to avoid log(0))
    ...
    entropy_a = [-(e / a_total_energy) * math.log((e / a_total_energy) + eps) for e in a_energy]
    entropy_g = [-(e / g_total_energy) * math.log((e / g_total_energy) + eps) for e in g_energy]
...
def data_generate():
    ...
    tar_dir = '39_Test_Dataset/tabular_data_test'
    pathlist_txt = Path(datapath).glob('**/3211.txt')
