...
from DCT_train import MLPClassifier as DCT_MLP
...
# === Test Dataset (flat features) ===
class TableTennisTestDataset(Dataset):
...
def run_inference(train_info_path, train_data_path):
    ...
    test_dataset = TableTennisTestDataset(train_info_path, train_data_path)
